...
var item_all = (function (_super) {
    ...
    function item_all() {
        ...
        _this.touch_flag = 0;
        // 把这个 类和皮肤 联系起来
        _this.skinName = 'resource/skins/skins_item/item_all.exml';
    ...
    item_all.prototype.dataChanged = function () {
        ...
        if (this.state_flag == 3) {
            ...
            if (this.state_flag == 0) {
                this.state_image.source = "resource/art/depot/stateGray.png";
            }
            else if (this.state_flag == 1) {
                this.state_image.source = "resource/art/depot/stateGreen.png";
            }
        }
    };
