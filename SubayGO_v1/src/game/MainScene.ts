class MainScene extends eui.Component implements  eui.UIComponent {
	...
	public mbtnMessage:eui.ToggleButton;//消息按钮变量
	public mbtnFriends:eui.ToggleButton;//好友按钮变量
	public mbtnLock:eui.ToggleButton;//解锁按钮变量
	public mbtnAbout:eui.ToggleButton;//关于按钮变量
	
	public Group_Ymenu:eui.Group;//定义Y菜单变量
	public mbtnfactory:eui.ToggleButton;//工厂按钮变量
	public mbtntask:eui.ToggleButton;//任务按钮变量
	public mbtnstage:eui.ToggleButton;//仓库按钮变量
	...
	public mbtnstrategy:eui.ToggleButton;//攻略按钮变量
	...
	public toggleXBtn(btn:eui.ToggleButton | number){
		//先把所有按钮都设为不选中
		for(let i=0;i<this.Group_Xmenu.numChildren;i++){
			let theBtn=<eui.ToggleButton>this.Group_Xmenu.getChildAt(i);
	...
	public toggleYBtn(btn:eui.ToggleButton | number){
		//先把所有按钮都设为不选中
		for(let i=0;i<this.Group_Ymenu.numChildren;i++){
			let theBtn=<eui.ToggleButton>this.Group_Xmenu.getChildAt(i);
			theBtn.selected=false;
		}
		//把传进来的btn设置为选中状态
