class DepotScene extends eui.Component implements  eui.UIComponent {
	...
	private dataArr:any[5]=[
			{image:"resource/assets/depot_picture/train0Blue.png",money:"运营量：800",name:"二号线",isNull:0},
			{image:"resource/assets/depot_picture/train2Red.png",money:"运营量：700",name:"一号线",isNull:0},
			{image:"resource/assets/depot_picture/train1Yellow.png",money:"运营量：600",name:"通鹏号",isNull:1},
			{image:"resource/assets/depot_picture/train2Blue.png",money:"运营量：400",name:"扬眉线",isNull:2},
			{image:"resource/assets/depot_picture/train1Blue.png",money:"运营量：300",name:"四号线",isNull:2},
		]
	private dataArr_all:any[]=[
		{image:"resource/assets/depot_picture/train1Blue.png",state:"resource/assets/depot_picture/stateGreen.png",name:"二号线",state_flag:1},
		{image:"resource/assets/depot_picture/train2Red.png",state:"resource/assets/depot_picture/stateGray.png",name:"一号线",state_flag:0},
		{image:"resource/assets/depot_picture/train1Yellow.png",state:"resource/assets/depot_picture/stateGray.png",name:"通鹏号",state_flag:0},
		{image:"resource/assets/depot_picture/train0Blue.png",state:"resource/assets/depot_picture/stateGreen.png",name:"七号线",state_flag:1},
		{image:"resource/assets/depot_picture/train2Blue.png",state:"resource/assets/depot_picture/stateGreen.png",name:"扬眉线",state_flag:0},
		{image:"resource/assets/depot_picture/train4Blue.png",state:"resource/assets/depot_picture/stateGray.png",name:"四号线",state_flag:0},
		]
